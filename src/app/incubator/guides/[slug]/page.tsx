    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Read Local Loop — people literally post what they're looking for and can't find.",
  ...
  "first-customers": {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Watch Local Loop for people requesting exactly what you offer, and reply.",
    ...
    cta: { label: "Open Local Loop →", href: "/community/eau-claire-wi" },
  },
  "local-bucks": {
