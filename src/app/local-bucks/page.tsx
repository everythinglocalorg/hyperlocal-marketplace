      ...
      <section className="max-w-3xl mx-auto px-6 pb-14">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {[
            ...
            { icon: "🏪", action: "Set up your storefront", bucks: "+25 LB", sub: "Businesses: complete your business profile" },
            { icon: "💳", action: "Connect Stripe", bucks: "+10 LB", sub: "Businesses: set up payouts and get paid online" },
            { icon: "🌐", action: "Connect your domain", bucks: "+10 LB", sub: "Businesses: point your own domain at your storefront" },
          ].map((e) => (
